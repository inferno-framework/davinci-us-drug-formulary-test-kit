require_relative '../../lib/davinci_pdex_drug_formulary_test_kit/reference_resolution_test'
...
RSpec.describe DaVinciPDEXDrugFormularyTestKit::ReferenceResolutionTest do
  ...
  describe '#perform_reference_resolution_test' do
    ...
    describe 'reference validation with target profiles' do
      let(:test_class) do
        Class.new(DaVinciPDEXDrugFormularyTestKit::DaVinciPDEXDrugFormularyV200::PayerInsurancePlanReferenceResolutionTest) do # rubocop:disable Layout/LineLength
          fhir_client { url :url }
          input :url
        end
      end
