require_relative '../../lib/davinci_pdex_drug_formulary_test_kit/must_support_test'
...
RSpec.describe DaVinciPDEXDrugFormularyTestKit::MustSupportTest do
  ...
  describe 'must support test for MedicationKnowledge elements' do
    let(:medication_must_support_test) do
      Inferno::Repositories::Tests.new.find('us_core_v200_medication_knowledge_must_support_test')
    end
    let(:medication1) do
  ...
  describe 'must support test for extensions' do
    let(:formulary_item_must_support_test) do
      Inferno::Repositories::Tests.new.find('us_core_v200_basic_must_support_test')
    end
  ...
  describe 'must support test for slices' do
    context 'when slicing with pattern' do
      let(:payer_insurance_plan_must_support_test) do
        Inferno::Repositories::Tests.new.find('us_core_v200_payer_insurance_plan_must_support_test')
      end
