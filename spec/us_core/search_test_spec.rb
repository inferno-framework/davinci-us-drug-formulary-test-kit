RSpec.describe DaVinciPDEXDrugFormularyTestKit::SearchTest do
  ...
  describe 'search with Encounter status with optional multiple-or requirement' do
    let(:patient_id) { '123' }
    let(:test_class) do
      Class.new(DaVinciPDEXDrugFormularyTestKit::USCoreV400::EncounterDatePatientSearchTest) do
        fhir_client { url :url }
        input :url, :patient_ids
      end
    end
  ...
  describe 'search with device filtering' do
    context 'when a list of codes is provided' do
      ...
      let(:test_class) do
        Class.new(DaVinciPDEXDrugFormularyTestKit::USCoreV311::DevicePatientSearchTest) do
          fhir_client { url :url }
  ...
  describe 'search date/dateTime precision' do
    ...
    context 'with date precision' do
      let(:test_class) do
        Class.new(DaVinciPDEXDrugFormularyTestKit::USCoreV400::GoalPatientTargetDateSearchTest) do
          fhir_client { url :url }
          input :url
        end
      end
    ...
    context 'with dateTime precision' do
      let(:test_class) do
        Class.new(DaVinciPDEXDrugFormularyTestKit::USCoreV400::ImmunizationPatientDateSearchTest) do
          fhir_client { url :url }
          input :url
        end
      end
  ...
  describe '#all_search_params' do
    let(:test_class) { DaVinciPDEXDrugFormularyTestKit::USCoreV311::DocumentReferencePatientCategoryDateSearchTest }
  ...
  describe '#search_param_value' do
    context 'Array element having DAR extension' do
      let(:test_class) { DaVinciPDEXDrugFormularyTestKit::USCoreV311::PatientNameSearchTest }
      let(:test) { test_class.new }
    ...
    context 'CodeablcConcept with text only' do
      let(:test_class) { DaVinciPDEXDrugFormularyTestKit::USCoreV311::DiagnosticReportLabPatientCategorySearchTest }
      let(:test) { test_class.new }
  ...
  describe '#perform_comparator_searches' do
    let(:test_class) do
      Class.new(DaVinciPDEXDrugFormularyTestKit::USCoreV311::ImmunizationPatientDateSearchTest) do
        fhir_client { url :url }
        input :url
      end
    end
  ...
  describe 'search_value contains comma' do
    let(:test_class) do
      Class.new(DaVinciPDEXDrugFormularyTestKit::USCoreV311::DiagnosticReportNotePatientCategoryDateSearchTest) do
        fhir_client { url :url }
        input :url
      end
    end
  ...
  describe 'search extension' do
    let(:test_class) do
      Class.new(DaVinciPDEXDrugFormularyTestKit::USCoreV501::ConditionEncounterDiagnosisPatientAssertedDateSearchTest) do
        fhir_client { url :url }
        input :url
      end
    end
