...
read succeeds.
      ...
      test from: :usdf_v200_basic_code_search_test
      test from: :usdf_v200_basic__id_search_test
      test from: :usdf_v200_basic__lastUpdated_search_test
      test from: :usdf_v200_basic_subject_search_test
      test from: :usdf_v200_basic_status_search_test
      test from: :usdf_v200_basic_period_search_test
      test from: :usdf_v200_basic_formulary_search_test
      test from: :usdf_v200_basic_pharmacy_benefit_type_search_test
      test from: :usdf_v200_basic_drug_tier_search_test
      ...
      test from: :usdf_v200_basic_must_support_test
      test from: :usdf_v200_basic_reference_resolution_test
    end
  end
end
