...
read succeeds.
      ...
      test from: :usdf_v200_formulary_status_search_test
      test from: :usdf_v200_formulary__id_search_test
      test from: :usdf_v200_formulary__lastUpdated_search_test
      test from: :usdf_v200_formulary_identifier_search_test
      test from: :usdf_v200_formulary_period_search_test
      test from: :usdf_v200_formulary_type_search_test
      test from: :usdf_v200_formulary_name_search_test
      test from: :usdf_v200_formulary_coverage_type_search_test
      test from: :usdf_v200_formulary_formulary_coverage_search_test
      test from: :usdf_v200_formulary_coverage_area_search_test
      test from: :usdf_v200_formulary_read_test
      test from: :usdf_v200_formulary_validation_test
      test from: :usdf_v200_formulary_must_support_test
    end
  end
end
