...
read succeeds.
      ...
      test from: :usdf_v200_medication_knowledge_status_search_test
      test from: :usdf_v200_medication_knowledge__id_search_test
      test from: :usdf_v200_medication_knowledge__lastUpdated_search_test
      test from: :usdf_v200_medication_knowledge_code_search_test
      test from: :usdf_v200_medication_knowledge_drug_name_search_test
      test from: :usdf_v200_medication_knowledge_doseform_search_test
      test from: :usdf_v200_medication_knowledge_read_test
      test from: :usdf_v200_medication_knowledge_validation_test
      test from: :usdf_v200_medication_knowledge_must_support_test
    end
  end
end
