require_relative 'formulary/formulary_status_search_test'
require_relative 'formulary/formulary_id_search_test'
require_relative 'formulary/formulary_lastupdated_search_test'
require_relative 'formulary/formulary_identifier_search_test'
require_relative 'formulary/formulary_period_search_test'
require_relative 'formulary/formulary_type_search_test'
require_relative 'formulary/formulary_name_search_test'
require_relative 'formulary/formulary_coverage_type_search_test'
...
The USDF Formulary sequence verifies that the system under test is
...
read succeeds.
      ...
      test from: :usdf_v201_formulary_status_search_test
      test from: :usdf_v201_formulary__id_search_test
      test from: :usdf_v201_formulary__lastUpdated_search_test
      test from: :usdf_v201_formulary_identifier_search_test
      test from: :usdf_v201_formulary_period_search_test
      test from: :usdf_v201_formulary_type_search_test
      test from: :usdf_v201_formulary_name_search_test
      test from: :usdf_v201_formulary_coverage_type_search_test
      test from: :usdf_v201_formulary_formulary_coverage_search_test
      test from: :usdf_v201_formulary_coverage_area_search_test
      test from: :usdf_v201_formulary_read_test
      test from: :usdf_v201_formulary_validation_test
      test from: :usdf_v201_formulary_must_support_test
    end
  end
end
